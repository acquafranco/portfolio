...
return [
    ...
    'projects' => [
        ...
        'items' => [
            ...
            'gula' => [
                'category' => 'Producto · Descubrimiento gastronómico',
                'description' => 'Plataforma para descubrir restaurantes, explorar sus propuestas y encontrar nuevos lugares para comer según lo que cada persona busca.',
                'problem' => 'Encontrar un restaurante muchas veces depende de búsquedas dispersas, recomendaciones aisladas y plataformas que no están pensadas alrededor de la experiencia de descubrir dónde comer.',
                'solution' => 'Una experiencia centrada en el descubrimiento gastronómico, que reúne restaurantes y su propuesta en un solo lugar para facilitar la búsqueda y ayudar a las personas a encontrar nuevos lugares.',
                'exploration_note' => 'GULA nace como una evolución de la idea de carta digital hacia una plataforma enfocada en el descubrimiento y la experiencia del cliente.',
            ],
        ],
    ],
